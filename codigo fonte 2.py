...
def get_mask_hsv(image, mask_lower=(0, 100, 100), mask_upper=(15, 255, 255)):
    ...
    # Cria uma máscara (pixels dentro do intervalo são brancos, o resto é preto)
...
if webcam.isOpened():
    ...
    while validacao:
        ...
        #  Aplica a máscara ao frame (Mostra APENAS a cor detectada)
        ...
        for contour in contours:
            # Filtro por área mínima para ignorar ruídos
        ...
        #  Exibe em três janelas SEPARADAS:
